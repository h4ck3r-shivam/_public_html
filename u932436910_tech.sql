...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 27, 2025 at 09:55 AM
...
(236, '2025-03-27 09:54:47', 1, 1, NULL, '{\"message\":\"Site configuration settings stored \\/ updated.\",\"data\":\"[]\"}');
...
(10, '2024-11-13 18:22:52', '2024-11-13 18:22:52', 'pusher_app_id', 'eyJpdiI6IlRaYUgrRDhUWCs0d3diYlJGQ1ozZ1E9PSIsInZhbHVlIjoicVFaRHRsUDI0Y3BsK3VGbEVVYTFwdz09IiwibWFjIjoiNTZhOGVkMmQzYjI2N2M5Y2VjNWJiZGZjNmQ0N2Y2MTI2YmU1NTNkY2E0NmIzYTY2MjM4MTE2N2RmNzA4ZjQ0YiIsInRhZyI6IiJ9', 1),
(11, '2024-11-13 18:22:52', '2024-11-13 18:22:52', 'pusher_app_key', 'eyJpdiI6IjVlNDhjak93VlFaSFN6NkdUUXJ5OFE9PSIsInZhbHVlIjoiWmlwdmJjRkpBTEtzYkQveDRoUktrekpnMGJGQkFxbkE5UlM5UWdKUnN6bz0iLCJtYWMiOiIzMWQxOGQzNWI3OTJjY2FiMzBjY2VkZjhmZjM3OTkzZjQ1ODA1NTBiMzMwODY0MGMyMjU2YjM5YWQ2ZTg2N2FhIiwidGFnIjoiIn0=', 1),
(12, '2024-11-13 18:22:52', '2024-11-13 18:22:52', 'pusher_app_secret', 'eyJpdiI6Ik52bVk1c2xmVlUySHJJZEc5RnMzOFE9PSIsInZhbHVlIjoidDgzS0VNRWdrRENpL0llVlRtSE4rdFJZcEJFRStNM0sxRGVVNWFQZ0M4bz0iLCJtYWMiOiIzZGM1OTY5NjU5ZmRlZDgxZWQ3ZmNjMDU4NDMwODQ3ZTllNjY2M2U3YjY3NmRjZDk5YzJmMTk4ODQ5YjlmMDAwIiwidGFnIjoiIn0=', 1),
(13, '2024-11-13 18:22:52', '2024-11-13 18:22:52', 'pusher_app_cluster', 'eyJpdiI6ImJORXk1YWlEZ21LM3ZudkVTdm9rTFE9PSIsInZhbHVlIjoiS1lLck1hZjdES3loc1JNK1RFYUI3dz09IiwibWFjIjoiYTdhNGZkYzE4ZGFjNzEyZDMzMjA4NGMwYTg2YTg3ZjM4ZTFlZmM1YjlkYTg5NGFjN2NiMjlmNzE4YzM3MTYxYyIsInRhZyI6IiJ9', 1),
...
(232, '2025-03-26 11:12:22', '2025-03-26 11:12:22', 'admin@example.in', 1, 1, '2401:4900:1c00:3ac4:167:699a:c704:e995'),
(233, '2025-03-27 09:54:10', '2025-03-27 09:54:10', 'admin@example.in', 1, 1, '2401:4900:1c00:3ac4:c468:c65d:bf0:4ed4');
...
(1, '50ee1967-7341-4c3a-b071-f2ea0722b179', '2024-11-13 17:26:47', '2025-03-27 09:54:24', 'superadmin', 'admin@example.in', '$2y$10$MSZxndE0sizE2b9rWU/RI.7BEfm3ioPFigDTL0u2A8GqTFsTzoi6u', 1, 'u2yJrj7AGPxkz0l0pIUKGG3SIYL7nD5UegoMeyqtpLXdzCP9pe2bDHwETzrw', 'Super', 'Administrator', '897987970', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL),
...
--
ALTER TABLE `contacts`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `group_contacts`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `login_logs`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=234;
...
--
ALTER TABLE `users`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `vendors`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `vendor_settings`
--
ALTER TABLE `vendor_settings`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `whatsapp_message_logs`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=582;

--
-- AUTO_INCREMENT for table `whatsapp_message_queue`
--
ALTER TABLE `whatsapp_message_queue`
  MODIFY `_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
